# 55tools-block
55tools-block is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
```bash
npm install 55tools-block
```
## Usage

const Web3Tools = require('55tools-block');
